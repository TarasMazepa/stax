...
Note: you can type first letter or couple of first letters instead of full command name. 'c' for 'commit' or 'am' for 'amend'.
 • amend, a - Amends and pushes changes.
      Flags:
         -A, --add-workspace - Runs 'git add -A' before other actions. Which adds tracked and untracked files in whole working tree.
         -a, --add-current - Runs 'git add .' before other actions. Which adds tracked and untracked files in current folder and subfolders.
         ...
         -u, --update-tracked - Runs 'git add -u' before other actions. Which adds only tracked files in whole working tree.
